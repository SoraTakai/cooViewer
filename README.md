...
- [`db20112`](https://github.com/SoraTakai/cooViewer/commit/db2011292b891b7352374274b30f2c923e39cb19): Add moved-file auto-apply preference and basename-based remap for `RecentItems`/`LastPages`. Example: move `Series01.cbz` to another folder, reopen it there, and previous page/settings are recovered instead of resetting to page 1.
